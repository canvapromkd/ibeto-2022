          ...
          <div className="guide__Dialog">
            ...
            <div className="rules_Dialog__content">
              <div className="rules__content">
                ...
                <a href="https://drive.google.com/file/d/1LCj-kh48mc1dCC__HxSyKcsof_qPelWd/view" target='blank'> <button style={{height:'2.5rem'}} className="about_btn guideBtn" onClick={handleOpen}>
                 Guidelines
                </button></a>
